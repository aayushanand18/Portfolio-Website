...
export const EXPERIENCES = [
  {
    ...
    description: `Pursuing a Bachelor of Technology (BTech) in Computer Science Engineering at Birla Institute of Technology, Mesra, with a current GPA of 8.05/10.00 (Absolute). Currently in the pre-final year, I am honing my skills in software development, an active member of Google Developer Student Clubs.`,
